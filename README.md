...
| Linux x86_64 | official WeChat 4.x Universal (`.deb` / AppImage) | raw/password mode selected by page-1 HMAC | child-process scan; optional LD_PRELOAD observer; `set-key` fallback |
